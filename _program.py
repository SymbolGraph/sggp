"""The underlying data structure used in steiner.

The :mod:`steiner._program` module contains the underlying representation of a
computer program. It is used for creating and evolving programs used in the
:mod:`steiner.genetic` module.
"""
...
class _Program(object):
    ...
    :mod:`steiner.genetic` module. It should not be used directly by the user.
